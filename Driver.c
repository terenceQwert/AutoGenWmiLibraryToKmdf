...
#pragma alloc_text (PAGE, MofHeaderGeneratorEvtDeviceAdd)
#pragma alloc_text (PAGE, MofHeaderGeneratorEvtDriverContextCleanup)
#endif
...
--*/
{
    ...
    attributes.EvtCleanupCallback = MofHeaderGeneratorEvtDriverContextCleanup;

    WDF_DRIVER_CONFIG_INIT(&config,
                           MofHeaderGeneratorEvtDeviceAdd
                           );
...
--*/
{
    ...
    status = MofHeaderGeneratorCreateDevice(DeviceInit);
...
VOID
MofHeaderGeneratorEvtDriverContextCleanup(
